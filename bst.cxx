...
extern void print_Point(FILE *f, PointType pt);
...
/********************************************************************/
void calc_mss ( AreaType *area ) {
int i,j,n_pt,n, n_sides;
double min_skew;
...
/********************************************************************/
void set_detour_EdgeLen(AreaType *area) {
...
/***********************************************************************/
double print_answer(const char fn[],int v, bool fixedTopology ) {
PointType p;
double Tcost = 0, Tdist=0, t, cap; 

  int n_detour_nodes = calc_TreeCost(v, &Tcost, &Tdist); 
  print_cluster_cost(Tcost);
  assert(equal(Tcost, Node[v].area[Node[v].ca].subtree_cost));
